...
class DefaultApi:
    ...
    def serve_models_post(
        ...
        :param var_self: (required)
        :type var_self: object
        :param serve_spec: (required)
        :type serve_spec: ServeSpec
        ...
        _param = self._serve_models_post_serialize(
            var_self=var_self,
    ...
    @validate_call
    def serve_models_post_with_http_info(
        self,
        var_self: Any,
        serve_spec: ServeSpec,
        _request_timeout: Union[
    ...
    @validate_call
    def serve_models_post_without_preload_content(
        self,
        var_self: Any,
        serve_spec: ServeSpec,
        _request_timeout: Union[
    ...
    def _serve_models_post_serialize(
        self,
        var_self,
        serve_spec,
        _request_auth,
