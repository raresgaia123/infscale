...
def train_base(args):
    ...
    tok = time.time()
    print(
        f"{tok - tik}, {(total_steps * engine.train_micro_batch_size_per_gpu()) / (tok - tik)}"
    )
    ...
    # tok = time.time()
    # print(f"{tok - tik}, {(total_steps * engine.train_micro_batch_size_per_gpu()) / (tok - tik)}")
